...
class ReadConfiguration(object):
    ...
    def readConfiguration():
        ...
        #  --------------------------------- Model Parameters -------------------------------------------
        parser.add_argument('--convolutional_units', type=int, default=1024, help='the number of convolutional unit in the convolutional layer')
        parser.add_argument('--conv_stride_size', type=int, default=3, help='the stride size of convolution')
        parser.add_argument('--conv_pooling_size', type=int, default=3, help='the pooling size in the pooling layer')
        parser.add_argument('--conv_dropout_rate', type=float, default=0.6, help='the dropout rate in the dropout layer')
        ...
        #  --------------------------------- Model Parameters -------------------------------------------
        Data.convolutional_units = args.convolutional_units
        Data.conv_stride_size = args.conv_stride_size
        Data.conv_pooling_size = args.conv_pooling_size
        Data.conv_dropout_rate = args.conv_dropout_rate
        ...
        print ('convolutional_units: %s' % Data.convolutional_units)
        print ('conv_stride_size: %s' % Data.conv_stride_size)
        print ('conv_pooling_size: %s' % Data.conv_pooling_size)
        print ('conv_dropout_rate: %s' % Data.conv_dropout_rate)
