...
#     fitted_vectorizer = vectorizer.fit(train_corpus)
#     return fitted_vectorizer

def content_tf_idf(utterances):
     # Text preprocessing 
    ...
    fitted_vectorizer = vectorizer.fit(utterances_text)
...
def extract_discourse_features(utterances):
    utterances_text = utterances[['text']].values.reshape(-1).tolist()
